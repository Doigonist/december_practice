...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 09 2024 г., 18:26
...
INSERT INTO `civilian` (`id_people`, `fio_people`, `login_people`, `password_people`, `status_people`, `adress_people`, `post_people`) VALUES
(1, 'Иванов Иван Иванович', 'User1', 'User1', 1, 1, 1),
(2, 'Васькин Илья  Владимирович', 'User2', 'User2', 2, 1, 1),
(3, 'Великий Виктор Михайлович', 'User3', 'User3', 3, 1, 2),
(4, 'Гегель Павел Викторович', 'User4', 'User4', 3, 1, 2),
(5, 'Дунилина Ангелина Александровна', 'User5', 'User5', 3, 1, 2),
(6, 'Жарова Елизавета Андреевна', 'User6', 'User6', 3, 1, 2),
...
(17, 'Соломка Егор Николаевич', 'User17', 'User17', 3, 3, 3),
...
(56, 'Стратонов Владислав Сергеевич', 'User56', 'User56', 3, 1, 4);
...
--
ALTER TABLE `adress`
  MODIFY `id_adress` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `civilian`
--
ALTER TABLE `civilian`
  MODIFY `id_people` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
